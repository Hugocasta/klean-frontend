...
/* Composant qui permet l'affichage des cleanwalks sur la page profil sous forme de liste scrollable */

function CleanwalkList(props) {

  const goCW = (id) => {
    props.setCwIdProfilStack(id);
    //La fonction passé en props "onPress" permet la navigation vers la page détail.
    props.onPress();
  }
