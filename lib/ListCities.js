...
/* Composant qui permet d'afficher le classement des villes sous forme de liste scrollable */

function ListCities(props) {

  const renderItem = ({ item, index }) => {
        /* Mise en forme différente s'il s'agit de la ville à laquelle j'appartiens (fond orange) */
