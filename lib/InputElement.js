  ...
  if (props.type === "simpleInput") {
    return (
      <View style={styles.inputContainer}>
        <TextInput
          style={styles.input}
          //Au changement de texte, modification de l'état associé à l'input via une fonction passé en props et affichage du composant autocomplete lorsque cela est nécessaire
